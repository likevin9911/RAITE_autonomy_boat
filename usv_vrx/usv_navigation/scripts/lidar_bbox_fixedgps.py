...
MIN_Z_HEIGHT = -1.5  # Set this value to your desired minimum Z height
FRONT_DEGREES = 60  # Degrees in front of the LiDAR to keep
...
def pointcloud_callback(pointcloud_msg):
    ...
    if len(front_cloud) > 0:
        ...
        ec.set_ClusterTolerance(0.2)  # Adjust as needed
...
if __name__ == "__main__":
    ...
    # Initialize TF listener and GPS storage
