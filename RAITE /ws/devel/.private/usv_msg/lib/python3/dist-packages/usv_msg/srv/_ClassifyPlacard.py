...
"""autogenerated by genpy from usv_msg/ClassifyPlacardRequest.msg. Do not edit."""
import codecs
import sys
...
class ClassifyPlacardRequest(genpy.Message):
  _md5sum = "b13d2865c5af2a64e6e30ab1b56e1dd5"
  _type = "usv_msg/ClassifyPlacardRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ClassifyPlacardRequest, self).__init__(*args, **kwds)
...
def _get_struct_BI():
    ...
    return _struct_BI
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from usv_msg/ClassifyPlacardResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class ClassifyPlacardResponse(genpy.Message):
  _md5sum = "16e1e649d067a97acc4d232e511729eb"
  _type = "usv_msg/ClassifyPlacardResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
"""
  __slots__ = ['label','confidence','centre_x','success']
  _slot_types = ['string','float32','int32','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       label,confidence,centre_x,success
    ...
    """
    if args or kwds:
      super(ClassifyPlacardResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.label is None:
        self.label = ''
      if self.confidence is None:
        self.confidence = 0.
      if self.centre_x is None:
        self.centre_x = 0
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_fiB().pack(_x.confidence, _x.centre_x, _x.success))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.confidence, _x.centre_x, _x.success,) = _get_struct_fiB().unpack(str[start:end])
...
def _get_struct_fiB():
    ...
    return _struct_fiB
class ClassifyPlacard(object):
  _type          = 'usv_msg/ClassifyPlacard'
  _md5sum = '564d8bb3409ecd03e36c23a70ebc1990'
  _request_class  = ClassifyPlacardRequest
  _response_class = ClassifyPlacardResponse
