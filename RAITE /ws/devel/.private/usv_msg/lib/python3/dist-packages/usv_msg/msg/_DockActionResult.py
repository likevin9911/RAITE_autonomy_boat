...
"""autogenerated by genpy from usv_msg/DockActionResult.msg. Do not edit."""
import codecs
import sys
...
class DockActionResult(genpy.Message):
  ...
  _type = "usv_msg/DockActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','usv_msg/DockResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = usv_msg.msg.DockResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = usv_msg.msg.DockResult()
