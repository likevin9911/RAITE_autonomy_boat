...
"""autogenerated by genpy from usv_msg/ClassifyBuoyRequest.msg. Do not edit."""
import codecs
import sys
...
class ClassifyBuoyRequest(genpy.Message):
  _md5sum = "23ce70aba6fc3266cf4deed40aa96c12"
  _type = "usv_msg/ClassifyBuoyRequest"
...
string frame_id
"""
  __slots__ = ['image','distance']
  _slot_types = ['sensor_msgs/Image','float32']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ClassifyBuoyRequest, self).__init__(*args, **kwds)
...
def _get_struct_f():
    ...
    return _struct_f
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from usv_msg/ClassifyBuoyResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class ClassifyBuoyResponse(genpy.Message):
  _md5sum = "93ef7f448bc67296eb1df2fd60b32075"
  _type = "usv_msg/ClassifyBuoyResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
"""
  __slots__ = ['type','confidence','success']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ClassifyBuoyResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_fB().pack(_x.confidence, _x.success))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.confidence, _x.success,) = _get_struct_fB().unpack(str[start:end])
...
def _get_struct_fB():
    ...
    return _struct_fB
class ClassifyBuoy(object):
  _type          = 'usv_msg/ClassifyBuoy'
  _md5sum = 'c33e4e3dce31d590391aa868e5718794'
  _request_class  = ClassifyBuoyRequest
  _response_class = ClassifyBuoyResponse
