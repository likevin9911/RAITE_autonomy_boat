...
(cl:defmethod cl:initialize-instance :after ((m <Object>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Object)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name usv_msg-msg:<Object> is deprecated: use usv_msg-msg:Object instead.")))

(cl:ensure-generic-function 'frame_id-val :lambda-list '(m))
(cl:defmethod frame_id-val ((m <Object>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader usv_msg-msg:frame_id-val is deprecated.  Use usv_msg-msg:frame_id instead.")
  (frame_id m))
...
(cl:ensure-generic-function 'best_guess-val :lambda-list '(m))
(cl:defmethod best_guess-val ((m <Object>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader usv_msg-msg:best_guess-val is deprecated.  Use usv_msg-msg:best_guess instead.")
  (best_guess m))

(cl:ensure-generic-function 'types-val :lambda-list '(m))
(cl:defmethod types-val ((m <Object>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader usv_msg-msg:types-val is deprecated.  Use usv_msg-msg:types instead.")
  (types m))

(cl:ensure-generic-function 'confidences-val :lambda-list '(m))
(cl:defmethod confidences-val ((m <Object>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader usv_msg-msg:confidences-val is deprecated.  Use usv_msg-msg:confidences instead.")
  (confidences m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Object>) ostream)
  ...
  (cl:let ((__ros_str_len (cl:length (cl:slot-value msg 'best_guess))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_str_len) ostream))
  (cl:map cl:nil #'(cl:lambda (c) (cl:write-byte (cl:char-code c) ostream)) (cl:slot-value msg 'best_guess))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Object>) istream)
  "Deserializes a message object of type '<Object>"
    ...
    (cl:let ((__ros_str_len 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'best_guess) (cl:make-string __ros_str_len))
      (cl:dotimes (__ros_str_idx __ros_str_len msg)
        (cl:setf (cl:char (cl:slot-value msg 'best_guess) __ros_str_idx) (cl:code-char (cl:read-byte istream)))))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Object>)))
  ...
  "dfbbde04b5fb0ebbe12079ff27956a67")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Object)))
  "Returns md5sum for a message object of type 'Object"
  "dfbbde04b5fb0ebbe12079ff27956a67")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Object>))
  (cl:+ 0
     ...
     4 (cl:length (cl:slot-value msg 'best_guess))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Object>))
  ...
  (cl:list 'Object
    ...
    (cl:cons ':best_guess (best_guess msg))
