...
# Scaling factors
LINEAR_SCALE = 1.0   # Adjusts the influence of linear velocity
...
# Channels (1-indexed)
LEFT_MOTOR_CHANNEL = 1      # Channel 1: Left Motor
RIGHT_MOTOR_CHANNEL = 4     # Channel 4: Right Motor
...
def cmd_vel_callback(msg, args):
    ...
    #update_plot(left_pwm,right_pwm,angular_vel,linear_vel)
...
# def update_plot(left_pwm,right_pwm,angular_vel,linear_vel):
#     current_time = rospy.get_time()
#     fig,axis= plt.subplots(4)
#     axis[0].plot(left_pwm,current_time)
#     axis[1].plot(right_pwm,current_time)
#     axis[2].plot(angular_vel,current_time)
#     axis[3].plot(linear_vel,current_time)
#     #plt.draw()
#     plt.show()
