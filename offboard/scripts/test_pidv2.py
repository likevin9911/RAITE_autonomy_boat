    ...
    def control_loop(self):
        ...
        while not rospy.is_shutdown():
            ...
            if goal_behind:
                ...
                linear_direction = -1.0  # Reverse direction
                adjusted_linear = linear_direction * self.adjust_linear_velocity_based_on_angular(
                    angular_error, max_linear_speed
                )
            else:
                ...
                adjusted_linear = self.adjust_linear_velocity_based_on_angular(
                    angular_error, self.max_linear_cmd
                )

            # PID for angular velocity
            adjusted_angular, self.integral_angular = self.compute_pid(
                angular_error, self.prev_error_angular, self.integral_angular,
